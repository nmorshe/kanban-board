...
export type GetCardsQuery = { __typename?: 'query_root', cards: Array<{ __typename?: 'cards', id: any, column_id: any, title: string, description?: string | null, updated_at: any }> };
...
export type CreateCardMutation = { __typename?: 'mutation_root', insert_cards_one?: { __typename?: 'cards', title: string, description?: string | null, position: any, column_id: any } | null };
...
export type UpdateCardMutation = { __typename?: 'mutation_root', update_cards_by_pk?: { __typename?: 'cards', id: any, title: string, description?: string | null, position: any, column_id: any } | null };
...
export type UpdateCardPositionMutation = { __typename?: 'mutation_root', update_cards?: { __typename?: 'cards_mutation_response', returning: Array<{ __typename?: 'cards', id: any, position: any, column_id: any }> } | null };
...
export type GetCardsBySubscriptionVariables = Exact<{
  column_id: Scalars['uuid']['input'];
}>;


export type GetCardsBySubscription = { __typename?: 'subscription_root', cards: Array<{ __typename?: 'cards', id: any, title: string, description?: string | null, position: any, column_id: any }> };
...
export type GetColumnsQuery = { __typename?: 'query_root', columns: Array<{ __typename?: 'columns', id: any, title: string, position: any }> };
...
export type CreateColumnMutation = { __typename?: 'mutation_root', insert_columns_one?: { __typename?: 'columns', id: any, title: string, position: any } | null };
...
export type UpdateColumnMutation = { __typename?: 'mutation_root', update_columns_by_pk?: { __typename?: 'columns', id: any, title: string } | null };
...
export type GetColumnsBySubscriptionVariables = Exact<{
  board_id: Scalars['uuid']['input'];
}>;


export type GetColumnsBySubscription = { __typename?: 'subscription_root', columns: Array<{ __typename?: 'columns', id: any, title: string, position: any, board_id: any }> };
...
export type GetBoardsQuery = { __typename?: 'query_root', boards: Array<{ __typename?: 'boards', id: any, name: string, created_at: any, updated_at: any }> };
...
export const CreateCardDocument = gql`
  ...
  insert_cards_one(
    object: {title: $title, description: $description, position: $position, column_id: $column_id}
  ) {
    title
    description
    position
...
export const UpdateCardPositionDocument = gql`
  ...
  update_cards(where: {id: {_eq: $id}}, _set: $set) {
    returning {
      id
      position
      column_id
...
export const GetCardsByDocument = gql`
...
/**
 * __useGetCardsBySubscription__
 *
 * To run a query within a React component, call `useGetCardsBySubscription` and pass it any options that fit your needs.
 * When your component renders, `useGetCardsBySubscription` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 ...
 * });
 */
export function useGetCardsBySubscription(baseOptions: Apollo.SubscriptionHookOptions<GetCardsBySubscription, GetCardsBySubscriptionVariables> & ({ variables: GetCardsBySubscriptionVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useSubscription<GetCardsBySubscription, GetCardsBySubscriptionVariables>(GetCardsByDocument, options);
      }
export type GetCardsBySubscriptionHookResult = ReturnType<typeof useGetCardsBySubscription>;
export type GetCardsBySubscriptionResult = Apollo.SubscriptionResult<GetCardsBySubscription>;
export const GetColumnsDocument = gql`
    query GetColumns($board_id: uuid!) {
  columns(where: {board_id: {_eq: $board_id}}, order_by: {position: asc}) {
    id
    title
    position
  }
...
export const CreateColumnDocument = gql`
    mutation CreateColumn($title: String!, $position: float8!, $board_id: uuid!) {
  insert_columns_one(
    object: {title: $title, position: $position, board_id: $board_id}
  ) {
    id
    title
    position
...
export const GetColumnsByDocument = gql`
    subscription GetColumnsBy($board_id: uuid!) {
  columns(where: {board_id: {_eq: $board_id}}, order_by: {position: asc}) {
    id
    title
    position
...
/**
 * __useGetColumnsBySubscription__
 *
 * To run a query within a React component, call `useGetColumnsBySubscription` and pass it any options that fit your needs.
 * When your component renders, `useGetColumnsBySubscription` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the subscription, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useGetColumnsBySubscription(baseOptions: Apollo.SubscriptionHookOptions<GetColumnsBySubscription, GetColumnsBySubscriptionVariables> & ({ variables: GetColumnsBySubscriptionVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useSubscription<GetColumnsBySubscription, GetColumnsBySubscriptionVariables>(GetColumnsByDocument, options);
      }
export type GetColumnsBySubscriptionHookResult = ReturnType<typeof useGetColumnsBySubscription>;
export type GetColumnsBySubscriptionResult = Apollo.SubscriptionResult<GetColumnsBySubscription>;
